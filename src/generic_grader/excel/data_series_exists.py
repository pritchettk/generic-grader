"""Compatibility wrapper for ratio-based data series search checks."""
...
def build(the_options):
    """Build a search-based data-series check via data_series_match_reference."""

    params = options_to_params(the_options)
    evolved = [
        evolve(option.args[0], range_matches_reference=False)
